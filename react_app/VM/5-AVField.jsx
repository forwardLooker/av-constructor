...
class AVFieldOriginal extends AVItem {
  ...
  render() {
    ...
    if (this.props.fieldItem.viewItemType === 'button') {
      return (
        <div className='_av-field-viewItem-root flex-1 col justify-center align-baseline pad-8-0'
             style={this.props.style}
             ref={this.props.refOnRootDiv}
        >
          <AVButton
    ...
    if (this.props.fieldItem.viewItemType === 'gazprombank carusel banners') {
      return (
        <div className='_av-field-viewItem-root'
          style={this.props.style}
          ref={this.props.refOnRootDiv}>
          <div className="row space-around">
            <div className='pos-rel col align-center' style={{ height: '560px', width: '400px', background: '#7b73fc', borderRadius: '16px' }}>
              <button className='margin-top-32' style={{ padding: '10px', border: 'none', borderRadius: '8px' }}>Сбережения</button>
            ...
            <div className='pos-rel col align-center' style={{ height: '560px', width: '400px', background: '#3356d7', borderRadius: '16px' }}>
              <button className='margin-top-32' style={{ padding: '10px', border: 'none', borderRadius: '8px' }}>Акция</button>
            ...
            <div className='pos-rel col align-center' style={{ height: '560px', width: '400px', background: '#5e81ff', borderRadius: '16px' }}>
              <button className='margin-top-32' style={{ padding: '10px', border: 'none', borderRadius: '8px' }}>Валюта</button>
